...
#This function counts the number of women and men of a nationality and also gives you the percentage over the total populaiton (in an ordered list from higher to lower proportion of women).
#Only when total population is higher than 5000.
...
#This funciton gives you a ranking of the amount of uses of computers and wifi of people from a neighborhood, in absolute numbers and relative to total population of area
...
#This function gives you a translation between numbers and the qualitative answers to the survey on "bretxa tecnològica"
...
#Main execution (includes global variables and function calls):
